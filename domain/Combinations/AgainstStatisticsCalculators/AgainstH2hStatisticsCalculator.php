...
//     * @param AmountNrCounterMap $amountNrCounterMapForSport
//     * @return list<OneVsOneHomeAway>
//     */
//    public function sortHomeAways(array $homeAways, AmountNrCounterMap $amountNrCounterMapForSport): array {
////        $time_start = microtime(true);
//
//        $leastAmountAssigned = [];
//        // $leastHomeAmountAssigned = [];
//        foreach($homeAways as $homeAway ) {
//            $leastAmountAssigned[$homeAway->getIndex()] = $this->getLeastAssigned($amountNrCounterMapForSport, $homeAway);
