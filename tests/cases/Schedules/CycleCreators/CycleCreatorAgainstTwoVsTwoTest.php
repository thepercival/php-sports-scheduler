...
class CycleCreatorAgainstTwoVsTwoTest extends TestCase
{
    ...
    public function test4NNrOfGames(): void
    {
        $this->hasValidNrOfGames(4, 1, 3);
        $this->hasValidNrOfGames(8, 1, 14);
        $this->hasValidNrOfGames(12, 1, 33);
        $this->hasValidNrOfGames(16, 1, 60);
        $this->hasValidNrOfGames(20, 1, 95);
        $this->hasValidNrOfGames(24, 1, 138);
        $this->hasValidNrOfGames(28, 1, 189);
        $this->hasValidNrOfGames(32, 1, 248);
        $this->hasValidNrOfGames(36, 1, 315);
        $this->hasValidNrOfGames(40, 1, 390);
        $this->hasValidNrOfGames(44, 1, 473);
    }

    public function test4NPlus1NrOfGames(): void
    {
        $this->hasValidNrOfGames(5, 1, 5);
        $this->hasValidNrOfGames(9, 1, 18);
        $this->hasValidNrOfGames(13, 1, 39);
        $this->hasValidNrOfGames(17, 1, 68);
        $this->hasValidNrOfGames(21, 1, 105);
        $this->hasValidNrOfGames(25, 1, 150);
        $this->hasValidNrOfGames(29, 1, 203);
        $this->hasValidNrOfGames(33, 1, 264);
        $this->hasValidNrOfGames(37, 1, 333);
        $this->hasValidNrOfGames(41, 1, 410);
        $this->hasValidNrOfGames(45, 1, 495);
    }
    ...
    {
        $cycleCreator = new CycleCreatorAgainstTwoVsTwo($this->createLogger());

        $sportWithNrOfNrOfCycles = new SportWithNrOfCycles(new AgainstTwoVsTwo(), $nrOfCycles);
        ...
        self::assertInstanceOf(ScheduleAgainstTwoVsTwo::class, $sportSchedule);
